...
<template>
    <div
        ...
        <div class="mb-24 space-y-6">
            <RouterLink :to="{ name: 'home' }" class="flex items-center gap-x-3 text-white">
                <svg class="size-6 fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
                    <path
            ...
            <RouterLink :to="{ name: 'addProgram' }" class="flex items-center gap-x-3 text-white">
            ...
            <RouterLink :to="{ name: 'addCourse' }" class="flex items-center gap-x-3 text-white">
            ...
            <RouterLink :to="{ name: 'addCourse' }" class="flex items-center gap-x-3 text-white">
                ...
                <h1 class="cursor-pointer text-xl">Add Question</h1>
            </RouterLink>
            <div class="flex items-center gap-x-3 text-white">
                ...
                <h1 class="cursor-pointer text-xl">New Request</h1>
            </div>
            <div class="flex items-center gap-x-3 text-white">
                ...
                <h1 class="cursor-pointer text-xl">Bug Report</h1>
            </div>
        </div>
